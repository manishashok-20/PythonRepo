...
def get_employee():
    ...
    if designation.lower() == "programmer":
        salary = 25000
    elif designation.lower() == "manager":
        salary = 30000
    elif designation.lower() == "tester":
        salary = 20000
    else:
        print("Unknown designation. Salary set to 0.")
        salary = 0
...
def main():
    ...
    while True:
        ...
        if choice == '1':
            ...
            display_employees()
            cont = input("\nDo you want to continue to the menu? (Y/n): ").strip().lower()
            if cont == 'n':
